...
//altsyncram ADDRESS_ACLR_B="NONE" ADDRESS_REG_B="CLOCK0" CLOCK_ENABLE_INPUT_A="BYPASS" CLOCK_ENABLE_INPUT_B="BYPASS" CLOCK_ENABLE_OUTPUT_B="BYPASS" DEVICE_FAMILY="Cyclone V" INIT_FILE="mem.hex" NUMWORDS_A=65536 NUMWORDS_B=65536 OPERATION_MODE="DUAL_PORT" OUTDATA_ACLR_B="NONE" OUTDATA_REG_B="CLOCK0" POWER_UP_UNINITIALIZED="FALSE" READ_DURING_WRITE_MODE_MIXED_PORTS="DONT_CARE" WIDTH_A=8 WIDTH_B=8 WIDTH_BYTEENA_A=1 WIDTHAD_A=16 WIDTHAD_B=16 address_a address_b clock0 data_a q_b wren_a
...
`endif
	...
	wire  [3:0]  w_anode581w;
	wire  [3:0]  w_anode591w;
	wire  [3:0]  w_anode601w;
	wire  [3:0]  w_anode611w;
	wire  [3:0]  w_anode621w;
	wire  [3:0]  w_anode631w;
	...
	assign
		...
		eq = eq_node,
		eq_node = eq_wire[7:0],
		eq_wire = {w_anode631w[3], w_anode621w[3], w_anode611w[3], w_anode601w[3], w_anode591w[3], w_anode581w[3], w_anode571w[3], w_anode554w[3]},
		w_anode554w = {(w_anode554w[2] & (~ data_wire[2])), (w_anode554w[1] & (~ data_wire[1])), (w_anode554w[0] & (~ data_wire[0])), enable_wire},
		w_anode571w = {(w_anode571w[2] & (~ data_wire[2])), (w_anode571w[1] & (~ data_wire[1])), (w_anode571w[0] & data_wire[0]), enable_wire},
		w_anode581w = {(w_anode581w[2] & (~ data_wire[2])), (w_anode581w[1] & data_wire[1]), (w_anode581w[0] & (~ data_wire[0])), enable_wire},
		w_anode591w = {(w_anode591w[2] & (~ data_wire[2])), (w_anode591w[1] & data_wire[1]), (w_anode591w[0] & data_wire[0]), enable_wire},
		w_anode601w = {(w_anode601w[2] & data_wire[2]), (w_anode601w[1] & (~ data_wire[1])), (w_anode601w[0] & (~ data_wire[0])), enable_wire},
		w_anode611w = {(w_anode611w[2] & data_wire[2]), (w_anode611w[1] & (~ data_wire[1])), (w_anode611w[0] & data_wire[0]), enable_wire},
		w_anode621w = {(w_anode621w[2] & data_wire[2]), (w_anode621w[1] & data_wire[1]), (w_anode621w[0] & (~ data_wire[0])), enable_wire},
		w_anode631w = {(w_anode631w[2] & data_wire[2]), (w_anode631w[1] & data_wire[1]), (w_anode631w[0] & data_wire[0]), enable_wire};
...
`endif
	...
	wire  [7:0]  eq_node;
	wire  [7:0]  eq_wire;
	wire  [3:0]  w_anode642w;
	wire  [3:0]  w_anode660w;
	wire  [3:0]  w_anode671w;
	wire  [3:0]  w_anode682w;
	wire  [3:0]  w_anode693w;
	wire  [3:0]  w_anode704w;
	wire  [3:0]  w_anode715w;
	...
	assign
		...
		eq = eq_node,
		eq_node = eq_wire[7:0],
		eq_wire = {w_anode726w[3], w_anode715w[3], w_anode704w[3], w_anode693w[3], w_anode682w[3], w_anode671w[3], w_anode660w[3], w_anode642w[3]},
		w_anode642w = {(w_anode642w[2] & (~ data_wire[2])), (w_anode642w[1] & (~ data_wire[1])), (w_anode642w[0] & (~ data_wire[0])), 1'b1},
		w_anode660w = {(w_anode660w[2] & (~ data_wire[2])), (w_anode660w[1] & (~ data_wire[1])), (w_anode660w[0] & data_wire[0]), 1'b1},
		w_anode671w = {(w_anode671w[2] & (~ data_wire[2])), (w_anode671w[1] & data_wire[1]), (w_anode671w[0] & (~ data_wire[0])), 1'b1},
		w_anode682w = {(w_anode682w[2] & (~ data_wire[2])), (w_anode682w[1] & data_wire[1]), (w_anode682w[0] & data_wire[0]), 1'b1},
		w_anode693w = {(w_anode693w[2] & data_wire[2]), (w_anode693w[1] & (~ data_wire[1])), (w_anode693w[0] & (~ data_wire[0])), 1'b1},
		w_anode704w = {(w_anode704w[2] & data_wire[2]), (w_anode704w[1] & (~ data_wire[1])), (w_anode704w[0] & data_wire[0]), 1'b1},
		w_anode715w = {(w_anode715w[2] & data_wire[2]), (w_anode715w[1] & data_wire[1]), (w_anode715w[0] & (~ data_wire[0])), 1'b1},
		w_anode726w = {(w_anode726w[2] & data_wire[2]), (w_anode726w[1] & data_wire[1]), (w_anode726w[0] & data_wire[0]), 1'b1};
endmodule //mem_decode1
...
//synthesis_resources = lut 43 M10K 64 reg 6 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
...
`endif
	...
	wire  [7:0]   wire_wren_decode_a_eq;
	...
	wire  [2:0]  rden_decode_addr_sel_b;
	wire  [2:0]  w_addr_val_a4w;
...
, wire_ram_block1a_6portbdataout[0], wire_ram_block1a_5portbdataout[0], wire_ram_block1a_4portbdataout[0], wire_ram_block1a_3portbdataout[0], wire_ram_block1a_2portbdataout[0], wire_ram_block1a_1portbdataout[0], wire_ram_block1a_0portbdataout[0]}),
	...
	assign
		...
		rden_decode_addr_sel_b = address_b_wire[15:13],
		w_addr_val_a4w = wren_decode_addr_sel_a,
		wren_decode_addr_sel_a = address_a_wire[15:13];
	initial/*synthesis enable_verilog_initial_construct*/
 	begin
		$display("Warning: MGL_INTERNAL_WARNING: (Invalid line found in memory file.  Invalid line --  -- found in file mem.hex)  ");
		$display("Warning: Memory initialization file mem.hex is not found. This may result in inconsistent simulation results.");
	end
